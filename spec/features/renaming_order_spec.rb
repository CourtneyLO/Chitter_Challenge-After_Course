...
feature "Changing Order", type: :feature do
  ...
  scenario 'I want to be able to see the lastest peep first' do
      ...
      expect(page).to have_selector("ul#peeps li:nth-child(1)", text: "Dan01")
      expect(page).to have_selector("ul#peeps li:nth-child(2)", text: "This is my second peep")
      expect(page).to have_selector("ul#peeps li:nth-child(5)", text: "This is my first peep")
  end
  ...
  scenario "I want to change oldest of peeps from oldest first" do
      ...
      expect(page).to have_selector("ul#peeps li:nth-child(5)", text: "This is my second peep")
    end
